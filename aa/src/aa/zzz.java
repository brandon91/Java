...
public class zzz extends JPanel {
	...
	public zzz(){
		...
		Pour que cette boucle ce fasse il te faut une classe Visiteur qui sera cr�e dans le package Mod�le qui aura 
		comme attribut(id,nom,prenom) et qui prendra en parametre tout ces attributs ,et aussi une fonction
		qui sera cr�e dans la classe mod�le qui renvoie un Arraylist de Visiteur .Cette fonction permettera de recuperer les visiteurs
		dans la base de donn�e et les ajoutes dans l'ArrayList.Ensuite il te faut dans la classe Visiteur
